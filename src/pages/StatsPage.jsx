...
export default function StatsPage() {
    const [showMainInputs, setShowMainInputs] = useState(false)
    ...
    return (
        <div>
            ...
            {showTempInputs && <div className="tempStats-inputs">
                ...
                />
                <button onClick={() => {
                    addTemporaryHealth(temporaryHealth);
                    resetForms()
                }}>
                ...
                <button onClick={() => {
                    resetTempStats(other.maxHealth)
                }}>
            ...
            {showMainInputs && <div className="stats-inputs">
                ...
                <div className="other-stats-inputs">
                    <input
                        type="number"
                        value={inspiration}
                ...
                <div className="mainStat-inputs">
                    ...
                    <button onClick={() => {
                        updateStats([strength, dexterity, constitution, intelligence, wisdom, charisma])
                    }}>
                    ...
                    />
                    <button onClick={() => {
                        changeProficiencyBonus(newProficiencyBonus)
                    }}>
