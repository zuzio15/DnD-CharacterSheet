...
export function useSpellSlot(){
    ...
    const deleteSlot =()=>{
        setSpellSlots([...spellSlots.slice(0,spellSlots.length-1)]);
    }
    ...
    return{spellSlots,createSlot,addSlot,subtractSlot,consumeSlot,restoreSlot, longRest,castSpell,deleteSlot}
}